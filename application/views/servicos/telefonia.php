		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-8">
				<ul class="list-inline" style="display: inline-flex; margin-left:-15px;">
					<li><img src="<?=base_url('assets/img/servicos/telefonia.png')?>" alt="Telefonia VoIp e PABx SmartTel"></li>							
					<li><h1><strong>Telefonia VoIp e PABx Smart<span style="color:#DD5724;">tel</span></strong></h1></li>
				</ul>	
			</div>
...
<section id="apresentacao">
	...
	<div class="row">
		...
		<div id="form-contato" class="col-xs-12 col-sm-12 col-md-3 col-lg-3 text-center">
			...
			<br>
			<br>
			<input type="hidden" name="assunto" id="assunto" value="Telefonia">
