		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-8">
				<ul class="list-inline" style="display: inline-flex; margin-left:-15px;">
					<li><img src="<?=base_url('assets/img/servicos/Capacitação.png')?>" alt="Capacitação SmartTel"></li>							
					<li><h1><strong>Capacitação Smart<span style="color:#DD5724;">tel</span></strong></h1></li>
				</ul>	
			</div>
...
<section id="apresentacao">
	...
	<div class="row">
		...
		<div id="form-contato" class="col-xs-12 col-sm-12 col-md-3 col-lg-3 text-center">
			...
			<?php echo form_open("index.php/servicos/capacitacao/enviar"); ?>
			...
			<br>
			<br>
			<input type="hidden" name="assunto" id="assunto" value="Capacitação">
...
<section id="porque">
	<div class="container text-center">
		<h2><strong>Por que fazer Capacitação<span style="color:#DD5724;">?</span></strong></h2>
		<hr>		
