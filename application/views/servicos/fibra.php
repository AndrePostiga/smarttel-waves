		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-8">
				<ul class="list-inline" style="display: inline-flex; margin-left:-15px;">
					<li><img src="<?=base_url('assets/img/servicos/fibra_optica.png')?>" alt="Fibra Óptica SmartTel"></li>							
					<li><h1><strong>Fibra Óptica Smart<span style="color:#DD5724;">tel</span></strong></h1></li>
				</ul>	
			</div>
...
<section id="apresentacao">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-lg-9 col-md-9 borda">
			...
			<?php echo form_open("index.php/servicos/fibra/enviar"); ?>
			...
			<br>
			<br>
			<input type="hidden" name="assunto" id="assunto" value="Fibra Optica">
