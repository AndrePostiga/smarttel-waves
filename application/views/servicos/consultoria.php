		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-8">
				<ul class="list-inline" style="display: inline-flex; margin-left:-15px;">
					<li><img src="<?=base_url('assets/img/servicos/consultoria.png')?>" alt="Projetos e Consultoria SmartTel"></li>							
					<li><h1><strong>Projetos e Consultoria Smart<span style="color:#DD5724;">tel</span></strong></h1></li>
				</ul>	
			</div>
